...
const (
	AuthAnonymous Access = iota // enable anonymous authentication
	AuthUsername                // enable username and password authentication
	AuthClientID                // enable clientid authentication
)
...
func (u UserRule) MarshalBinary() (data []byte, err error) {
	return json.Marshal(u)
}

// UnmarshalBinary decodes a json string into a struct.
func (u *UserRule) UnmarshalBinary(data []byte) error {
	if len(data) == 0 {
		return nil
	}
...
// MarshalBinary encodes the values into a json string.
func (a AuthRule) MarshalBinary() (data []byte, err error) {
	return json.Marshal(a)
}

// UnmarshalBinary decodes a json string into a struct.
func (a *AuthRule) UnmarshalBinary(data []byte) error {
	if len(data) == 0 {
		return nil
	}
...
// MarshalBinary encodes the values into a json string.
func (c ACLRule) MarshalBinary() (data []byte, err error) {
	return json.Marshal(c)
}

// UnmarshalBinary decodes a json string into a struct.
func (c *ACLRule) UnmarshalBinary(data []byte) error {
	if len(data) == 0 {
		return nil
	}
